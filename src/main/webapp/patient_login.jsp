...
<body>
	...
	<div id="formbody">
		<div id="login">
			<h1 style="color: #218838; text-align: center;">Patient Login</h1>
			<%
			if (message != null) {
			%>
			...
			%>
			<form id="loginForm" action="patientlogin" method="POST">
				<%
				if (usernameMsg != null) {
				%>
			...
			<p id="message" style="margin-top: 30px">
				Don't have an account? <a href='patient_register.jsp'>Register
					Now</a>
			</p>
		</div>
